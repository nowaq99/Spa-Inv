...
public class MainConst {
    ...
    public final static int mainExitButtonX = 150;
    public final static int mainExitButtonY = 400;
    public final static int endExitButtonX = 550;
    public final static int endExitButtonY = 400;

    public final static String newGameButtonText = "New Game";
    public final static int mainNewGameButtonX = 150;
    public final static int mainNewGameButtonY = 200;
    public final static int endNewGameButtonX = 50;
    public final static int endNewGameButtonY = 400;

    public final static String statsButtonText = "Stats";
    public final static int endStatsButtonX = 300;
    public final static int endStatsButtonY = 400;
    ...
    public final static int KrzychuHeight = 24;
    public final static int KrzychuWidth = 36;

    public final static int RychuHeight = 24;
    public final static int RychuWidth = 33;

    public final static int ZdzichuHeight = 24;
    public final static int ZdzichuWidth = 24;

    public final static int lifeWidth = 30;
    public final static int lifeHeight = 30;
    public final static int lifeStartX = paneWidth - 50;
    public final static int lifeInterspace = 40;
    public final static int lifeY = 40;
